...
const { registerUser, loginUser, logoutUser, forgotPassword, resetPassword, getMyDetails, updatePassword, updateProfile, getAllUsers, getSingleUser, updateUserRole, deleteUser } = require('../controllers/userController');
